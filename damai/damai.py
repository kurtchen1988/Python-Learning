...
URL = "https://piao.damai.cn/146402.html?spm=a2o6e.search.0.0.6f4e642bEbUqZF"# PC页面

# URL = 'https://m.damai.cn/damai/perform/item.html?projectId=146402'#手机页面
# HOUR = 19
MIN  = 0
...
def login():
    # 点击登录
    login = choose('.//span[@class="sign"]/a[1]')
    # login = choose('//*[@id="userLoginInfo"]/span/a[0]')
    login.click()
...
def buy():
    ...
    try:
        ...
        while None == price:
            ...
            price = choose('//*[@id="priceList"]/div/ul/li[6]')
        price.click()
        # 数量加1
        while None == plus:
