...
from web.views import index,cart,orders,vip,register
...
urlpatterns = [
    ...
    # 会员注册
    url(r'^register$', register.regist, name='register'),
    url(r'^register/regist', register.addvip, name='register_add')
